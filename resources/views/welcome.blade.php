        ...
        <!-- Brand and toggle get grouped for better mobile display -->
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><span class="logo-wraper logo-white">
                <img src="images/Logo.png" alt="">Repuestos
              </span></a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav  navbar-right">
              ...
              <li><a href="#newsletter">Registro</a></li>
              <li><a href="{{ url('/admin/profile') }}" class="btn btn-orange border-none btn-rounded-corner btn-navbar">Inicio<span class="icon-on-button"><i class="ion-ios-cloud-download-outline"></i></span></a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
      ...
      <div id="home-slider" class="owl-carousel">
        <div>
          <div class="sliding-card-with-bottom-image text-center padding-top-90">
            <h2 class="cta-heading text-white">{{ setting('site.title') }}</h2>
            <p class="text-white slider-para">{{ setting('site.description') }}</p>
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 padding-top-bottom-90">
                <div class="subscription-wraper text-center">
                  <h4 class="text-upper">Registrate</h4>
                  <!-- <p>Enter your email address for our weekly new update</p> -->
                  <form class="subscription-form" action="{{ url('/registro') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <button class="btn btn-orange border-none btn-rounded-corner"  type="submit" >Enviar<span class="icon-on-button"><i class="ion-ios-arrow-thin-right"></i></span></button>
                  </form>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="copyright-cta">
            <p class="text-uppercase">All rights Reserved By <a href="https://themewagon.com/"><span class="span text-violat ">LoginWeb 2018</span></a></p>
          </div>
        </div>
      </div>
